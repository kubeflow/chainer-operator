...
import (
	...
	"github.com/kubeflow/chainer-operator/pkg/client/clientset/versioned/scheme"
...
func (c *KubeflowV1alpha1Client) ChainerJobs(namespace string) ChainerJobInterface {
	return newChainerJobs(c, namespace)
}
